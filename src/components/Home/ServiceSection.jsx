...
const services = [
  {
    title: "ECU Remapping",
    desc: `Improves your vehicle’s power, torque, and fuel efficiency by optimising the engine’s software.`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Ceramic Coatings",
    desc: `Adds a long-lasting protective layer to your vehicle’s paint, enhancing shine and resisting scratches, dirt, and UV damage.
​`,
    image: "/gray.avif",
  ...
  {
    title: "Tinting",
    desc: `Reduces heat and glare while adding privacy and protecting the interior from harmful sunlight.`,
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 w-[55%] rounded-2xl mt-15 mx-auto h-55 object-cover"
                    onError={(e) => {
